...
const FRONT_END_ABI_FILE = "../Ethereum_Transfer_NextJS/constants/contractABI.json";
const FRONT_END_ADDRESS_FILE = "../Ethereum_Transfer_NextJS/constants/contractAddress.json";
 const main = async ()=>{
  if(process.env.UPDATE_FRONT_END){
    console.log("Writing to front end...")
    const contract = await deployments.get("TransferETH")
